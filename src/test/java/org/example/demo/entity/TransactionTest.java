...
public class TransactionTest {
    ...
    public void shouldSetAndGetTransactionIDCorrectly(int id) {
    ...
    public void shouldSetAndGetPatronIDCorrectly(int patronID) {
    ...
    public void shouldSetAndGetDatesCorrectly(String borrowed, String returned, String due) {
    ...
    public void shouldSetAndGetTransactionAttributesCorrectly(int id, int bookID, int patronID, String borrowed, String returned, String due) {
        Date borrowedDate = Date.valueOf(borrowed);
        Date returnedDate = Date.valueOf(returned);
        Date dueDate = Date.valueOf(due);
    ...
    public void shouldSetAndGetPatronIDForMemberCorrectly(int memberID) {
