...
public class BookTest {
    ...
    public void testGetAndSetDescription(String description) {
    ...
    public void testGetAndSetAuthor(String author) {
    ...
    public void testGetAndSetIsbn(String isbn) {
        book.setIsbn(isbn);
    ...
    public void testGetAndSetQuantity(int quantity) {
    ...
    public void testConstructorWithTitleDescriptionAuthorIsbnPublishedYear(String title, String description, String author, String isbn, int publishedYear) {
